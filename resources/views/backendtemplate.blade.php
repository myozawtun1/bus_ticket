...
<head>
  ...
  <link href="{{asset('bus_admin/css/sb-admin-2.min.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="{{asset('bus_admin/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{asset('bus_admin/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

  <!-- Core plugin JavaScript-->
  <script src="{{asset('bus_admin/vendor/jquery-easing/jquery.easing.min.js')}}"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{asset('bus_admin/js/sb-admin-2.min.js')}}"></script>

  <!-- Page level plugins -->
  <script src="{{asset('bus_admin/vendor/chart.js/Chart.min.js')}}"></script>

  <!-- Page level custom scripts -->
  <script src="{{asset('bus_admin/js/demo/chart-area-demo.js')}}"></script>
  <script src="{{asset('bus_admin/js/demo/chart-pie-demo.js')}}"></script>
  @yield('script')
